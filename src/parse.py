...
class TopDownParser(nn.Module):
    def __init__(
        ...
        self.word_embeddings = torch.load('models/fasttext_init_embeddings.pt')      #   self.word_embeddings = nn.Embedding(word_vocab.size, word_embedding_dim)
